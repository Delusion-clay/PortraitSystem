 ...
 */
public class KeywordMonthAnaly {
    public static void main(String[] args) {
        final ExecutionEnvironment env = ExecutionEnvironment.getExecutionEnvironment();

        DataSet<String> fileSource =  env.readTextFile("hdfs://hadoop-101://orderinfomonth2.file");
        ...
        try {
            ...
            for(KeywordEntity keywordEntity:result){
                ...
                String tablenamenew = "keywordfenbuMonthinfo";
...
//            mapfinalresult.writeAsText("hdfs://hadoop-101/test");//hdfs的路径
            env.execute("KeywordMonthAnaly");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
