...
@RequestMapping("api")
@CrossOrigin
public class WooldayinfoControl {

    @RequestMapping(value = "wooldayinfoData",method = RequestMethod.POST)
    public CurveEntity curveData(){

        String sql = "select timeinfoString,sum(numbers) as nubmers from wooldayinfo group by timeinfoString order by timeinfoString";
        ...
        try {
            ...
            while(resultSet.next()){
                ...
                Map<String,Long> datainnerMap = dataMap.get("羊毛党");
