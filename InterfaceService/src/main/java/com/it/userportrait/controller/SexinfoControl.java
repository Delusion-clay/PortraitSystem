...
@RequestMapping("api")
@CrossOrigin
public class SexinfoControl {

    @RequestMapping(value = "sexinfoData",method = RequestMethod.POST)
    public CurveEntity curveData(){
        //最近一小时
        String sql = "select sex,timeinfoString,sum(numbers) as nubmers from youfansexinfo group by sex,timeinfoString order by timeinfoString";
        ...
        try {
            ...
            while(resultSet.next()){
                ...
                Map<String,Long> datainnerMap = dataMap.get(sex);
