...
@RequestMapping("api")
@CrossOrigin
public class KeywordMonthControl {

    @RequestMapping(value = "youfanKeywordMonthData",method = RequestMethod.POST)
    public CurveEntity curveData(){

        String sql = "select topn,timeinfoString,sum(numbers) as nubmers from keywordfenbuMonthinfo group by topn,timeinfoString order by timeinfoString";
        ...
        Collections.sort(sortList, new Comparator<String>() {
            ...
            public int compare(String o1, String o2) {
                int reuslt = 0;
                try {
                    reuslt = DateUtils.compareDate(o1,o2,"yyyyMM");
