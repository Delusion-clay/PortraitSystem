...
@RequestMapping("api")
@CrossOrigin
public class EntanglementProductControl {

    @RequestMapping(value = "entanglementProductData",method = RequestMethod.POST)
    public CurveEntity curveData(){
        //
        String sql = "select productid,timeinfoString,sum(numbers) as nubmers from entanglementProducInfo group by productid,timeinfoString order by timeinfoString";
        ...
        try {
            ...
            while(resultSet.next()){
                ...
                Map<String,Long> datainnerMap = dataMap.get(productid);
                ...
                dataMap.put(productid,datainnerMap);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        for(Map.Entry<String,Map<String,Long>> entry:dataMapSet){
            ...
            try {
                name = HbaseUtils2.getdata("product",name,"info","productname");
            } catch (Exception e) {
                e.printStackTrace();
            }
