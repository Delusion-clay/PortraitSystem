...
public class CarrierControl {
    ...
    @RequestMapping(value = "carrierData",method = RequestMethod.POST)
    public CurveEntity curveData(){
        //最近一小时
        String sql = "select carrierString,timeinfoString,sum(numbers) as nubmers from carrierinfo group by carrierString,timeinfoString order by timeinfoString";
