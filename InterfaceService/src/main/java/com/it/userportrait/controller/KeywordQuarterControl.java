...
@RequestMapping("api")
@CrossOrigin
public class KeywordQuarterControl {

    @RequestMapping(value = "youfanKeywordQuarterData",method = RequestMethod.POST)
    public CurveEntity curveData(){

        String sql = "select topn,timeinfoString,sum(numbers) as nubmers from keywordfenbuuQuarterinfo group by topn,timeinfoString order by timeinfoString";
