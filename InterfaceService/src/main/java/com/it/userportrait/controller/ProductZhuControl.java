...
@RequestMapping("api")
@CrossOrigin
public class ProductZhuControl {
    ...
    @RequestMapping(value = "productZhuData",method = RequestMethod.POST)
    public CurveEntity curveData(){

        String sql = "select productzhuFlag,timeinfoString,sum(numbers) as nubmers from productZhuinfo group by productzhuFlag,timeinfoString order by timeinfoString";
        ...
        try {
            ...
            while(resultSet.next()){
                String productzhuFlag = resultSet.getString("productzhuFlag");
                String timeinfoString = resultSet.getString("timeinfoString");
                long numbers = resultSet.getLong("nubmers");
                dateSet.add(timeinfoString);
                productzhuFlag =  dictmap.get(productzhuFlag);
                Map<String,Long> datainnerMap = dataMap.get(productzhuFlag);
                ...
                dataMap.put(productzhuFlag,datainnerMap);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        Collections.sort(sortList, new Comparator<String>() {
            ...
            public int compare(String o1, String o2) {
                int reuslt = 0;
                try {
                    reuslt = DateUtils.compareDate(o1,o2,"yyyyMMdd");
