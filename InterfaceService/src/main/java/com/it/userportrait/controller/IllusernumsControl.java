...
@RequestMapping("api")
@CrossOrigin
public class IllusernumsControl {

    @RequestMapping(value = "illusernumsData",method = RequestMethod.POST)
    public CurveEntity curveData(){

        String sql = "select illusernums,timeinfoString,sum(numbers) as nubmers from illusernumsbyinfo group by illusernums,timeinfoString order by timeinfoString";
        ...
        try {
            ...
            while(resultSet.next()){
                ...
                dataMap.put(illusernums,datainnerMap);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
